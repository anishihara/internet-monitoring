...
> This repository is a fork from [maxandersen/internet-monitoring](https://github.com/maxandersen/internet-monitoring), tailored for use on a Raspberry Pi. It has been tested on a Raspberry Pi 3 and 4 running Pi OS.
...
```
git clone https://github.com/anishihara/internet-monitoring
...
username - admin
password - senha_qualquer (Password is stored in the `config.monitoring` env file)
